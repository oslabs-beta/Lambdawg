        ...
        <div id="landing-page-flex">
          <div className="info-card-wrapper">
            <div className="info-card">
              <h1>MEDIA</h1>Another peek into the amazing world of our developer mindsAnother peek into the amazing
            ...
            <div className="info-card">
              <h1>DOCS</h1>Another peek into the amazing world of our developer mindsAnother peek into the amazing world
              of our developer mindsAnother peek into the amazing world{" "}
            </div>
          </div>
