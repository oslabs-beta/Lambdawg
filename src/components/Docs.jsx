...
const Docs = () => {
  return (
    <div id="docs-page">
      ...
      <h2>What it do baby - I kinda wanna keep this</h2>
      <p className="docs-first-line">Lambdawg is your go-to AWS Lambda Function visualization UI.</p>
      <p>
        Simply connect your AWS account in the Settings page above, and boom boom bam - you'll get your trace, metrics,
        and log data in one simple, streamlined interface.
      </p>
      ...
      <h4 className="docs-dev">
        <span>
          Check us out on <a href="https://github.com/oslabs-beta/Lambdawg">Github</a>!
        </span>
      </h4>
      ...
      <p className="docs-dev">
        ...
        <span>
          <a href="https://github.com/oslabs-beta/Lambdawg">click here</a> to learn more about Lambdawg!
        </span>
      </p>
    </div>
  );
